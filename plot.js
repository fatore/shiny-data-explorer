...
// crate colorScale scale
var colorScale = d3.scale.category10();

// domain is the max and min of each dimension
var domainByTrait = {};

// d3.keys is equivalent to colnames, data[0] is the first row of the matrix
...
svg = d3.select("#scatterplot").append("svg")
  ...
  function plot(p) {
    ...
    cell.selectAll("circle")
        ...
        .attr("r", 3)
        .style("fill", function(d) { return colorScale(p.y+(d[p.y]>0)); });
